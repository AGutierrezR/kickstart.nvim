	...
	{ -- Useful plugin to show you pending keybinds.
		...
		opts = {
			...
			spec = {
				...
				{ "<leader>g", group = "Git", mode = { "n", "v" } }, -- Enable gitsigns recommended keymaps first
	...
	},
	{
		...
		keys = {
			...
			},
			{
				"g!",
				function()
					require("improved-search").current_word_strict()
				end,
				mode = "n",
			},
			{
			...
			},
			{
				"g!",
				function()
					require("improved-search").in_place_strict()
				end,
				mode = "x",
			},
			{
			...
			},
			{
				"g*",
				function()
					require("improved-search").forward_strict()
				end,
				mode = "x",
			},
			{
			...
			},
			{
				"g#",
				function()
					require("improved-search").backward_strict()
				end,
				mode = "x",
			},
		},
